...
#include "/home/lesliefang/pytorch_1_7_1/quantization/pytorch/torch/_inductor/codegen/cpp_prefix.h"
            ...
            {              
                ...
                }
                {
                    for(long x1=static_cast<long>(0L); x1<static_cast<long>(1024L); x1+=static_cast<long>(16L))
                    {
                        ...
                        auto tmp0 = at::vec::Vectorized<float>::loadu(buffer_data + x1);
