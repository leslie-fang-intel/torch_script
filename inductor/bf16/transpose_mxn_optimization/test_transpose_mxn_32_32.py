...
extern "C" void kernel(const bfloat16* in_ptr0,
                       bfloat16* out_ptr0)
{
    at::vec::transpose_mxn<bfloat16,32,32>(in_ptr0, 32, out_ptr0, 32);
}
''')
...
def call(args):
    ...
    buf0 = rand_strided((32, 32), (32, 1), device='cpu', dtype=torch.bfloat16)
    buf1 = rand_strided((32, 32), (32, 1), device='cpu', dtype=torch.bfloat16)
    buf2 = rand_strided((32, 32), (32, 1), device='cpu', dtype=torch.bfloat16)
