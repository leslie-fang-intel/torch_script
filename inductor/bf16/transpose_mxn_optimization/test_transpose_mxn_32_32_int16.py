...
extern "C" void kernel(const int16_t* in_ptr0,
                       int16_t* out_ptr0)
{
    int M = 32;
    int N = 32;
...
extern "C" void kernel(const int16_t* in_ptr0,
                       int16_t* out_ptr0)
{
    at::vec::transpose_mxn<int16_t,32,32>(in_ptr0, 32, out_ptr0, 32);
}
''')
...
def call(args):
    ...
    buf0 = rand_strided((32, 32), (32, 1), device='cpu', dtype=torch.int16)
    buf1 = rand_strided((32, 32), (32, 1), device='cpu', dtype=torch.int16)
    buf2 = rand_strided((32, 32), (32, 1), device='cpu', dtype=torch.int16)
