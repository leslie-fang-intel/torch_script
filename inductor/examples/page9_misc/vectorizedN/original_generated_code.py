...
{
    {
        ...
        {
            auto tmp0 = at::vec::Vectorized<bfloat16>::loadu(in_ptr0 + static_cast<int64_t>(x0), 16);
            auto tmp2 = at::vec::Vectorized<bfloat16>::loadu(in_ptr1 + static_cast<int64_t>(x0), 16);
