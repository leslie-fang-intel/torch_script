...
_frozen_param2 = None  # device(type='cpu') torch.bfloat16 (11008, 4096) (1, 0) 7f9fdedc0450
constant1 = None  # device(type='cpu') torch.bfloat16 (344, 4096, 32) (131072, 32, 1) 7f9fde2071f0


cpp_fused_mm_mul_0 = async_compile.cpp_pybinding(['const bfloat16*', 'const bfloat16*', 'const bfloat16*', 'bfloat16*'], '''
...
extern "C" 
void kernel(const bfloat16* X, const bfloat16* W, const bfloat16* in_ptr2, bfloat16* Y)
{
                ...
                {
                    {
                        ...
                        for(int64_t x0=static_cast<int64_t>(0L); x0<static_cast<int64_t>(m_end + ((-1L)*m_start)); x0+=static_cast<int64_t>(1L))
                        {
                            for(int64_t x1=static_cast<int64_t>(0L); x1<static_cast<int64_t>(16L*(c10::div_floor_integer(static_cast<int64_t>((n_end + ((-1L)*n_start))), static_cast<int64_t>(16L)))); x1+=static_cast<int64_t>(16L))
                            {
                                ...
                                auto tmp1 = at::vec::Vectorized<bfloat16>::loadu(in_ptr2 + static_cast<int64_t>(n_start + x1 + (11008L*m_start) + (11008L*x0)), static_cast<int64_t>(16));
                                auto tmp2 = at::vec::convert<float>(tmp1);
                                auto tmp3 = tmp0 * tmp2;
                                auto tmp4 = at::vec::convert<bfloat16>(tmp3);
                                tmp4.store(Y + static_cast<int64_t>(n_start + x1 + (11008L*m_start) + (11008L*x0)), static_cast<int64_t>(16));
                            }
                            for(int64_t x1=static_cast<int64_t>(16L*(c10::div_floor_integer(static_cast<int64_t>((n_end + ((-1L)*n_start))), static_cast<int64_t>(16L)))); x1<static_cast<int64_t>(n_end + ((-1L)*n_start)); x1+=(static_cast<int64_t>(n_end + ((-1L)*n_start) + ((-16L)*(c10::div_floor_integer(static_cast<int64_t>((n_end + ((-1L)*n_start))), static_cast<int64_t>(16L))))) == 0 ? 1 : static_cast<int64_t>(n_end + ((-1L)*n_start) + ((-16L)*(c10::div_floor_integer(static_cast<int64_t>((n_end + ((-1L)*n_start))), static_cast<int64_t>(16L)))))))
                            {
                                ...
                                auto tmp1 = at::vec::Vectorized<bfloat16>::loadu(in_ptr2 + static_cast<int64_t>(n_start + x1 + (11008L*m_start) + (11008L*x0)), static_cast<int64_t>(n_end + ((-1L)*n_start) + ((-16L)*(c10::div_floor_integer(static_cast<int64_t>((n_end + ((-1L)*n_start))), static_cast<int64_t>(16L))))));
                                auto tmp2 = at::vec::convert<float>(tmp1);
                                auto tmp3 = tmp0 * tmp2;
                                auto tmp4 = at::vec::convert<bfloat16>(tmp3);
                                tmp4.store(Y + static_cast<int64_t>(n_start + x1 + (11008L*m_start) + (11008L*x0)), static_cast<int64_t>(n_end + ((-1L)*n_start) + ((-16L)*(c10::div_floor_integer(static_cast<int64_t>((n_end + ((-1L)*n_start))), static_cast<int64_t>(16L))))));
                            }
                        }
                    }
...
def call(args):
    ...
    assert_size_stride(arg2_1, (32256, 11008), (11008, 1))
    buf1 = empty_strided_cpu((32256, 11008), (11008, 1), torch.bfloat16)
    cpp_fused_mm_mul_0(arg1_1, constant1, arg2_1, buf1)
    del arg1_1
    del arg2_1
    return (buf1, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg2_1 = rand_strided((32256, 11008), (11008, 1), device='cpu', dtype=torch.bfloat16)
