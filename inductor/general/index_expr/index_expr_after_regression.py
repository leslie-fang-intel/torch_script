        ...
        for(long x0=static_cast<long>(0L); x0<static_cast<long>(12L); x0+=static_cast<long>(1L))
        {
            ...
            for(long x1=static_cast<long>(0L); x1<static_cast<long>(64L); x1+=static_cast<long>(1L))
            {
                for(long x2=static_cast<long>(0L); x2<static_cast<long>(192L); x2+=static_cast<long>(16L))
                {
                    ...
                    ()
                    ;
                    TORCH_CHECK((at::vec::VecMask<int32_t,1>((at::vec::Vectorized<int32_t>(0) <= tmp7) & (tmp7 < at::vec::Vectorized<int32_t>(13L)))).all_masked(), "index out of bounds: 0 <= tmp7 < 13L");
                    auto tmp9 =
                    [&]
                    {
                    ...
                    ()
                    ;
                    TORCH_CHECK((at::vec::VecMask<int32_t,1>((at::vec::Vectorized<int32_t>(0) <= tmp17) & (tmp17 < at::vec::Vectorized<int32_t>(13L)))).all_masked(), "index out of bounds: 0 <= tmp17 < 13L");
                    auto tmp19 =
                    [&]
                    {
                        __at_align__ std::array<float, 16> tmpbuf;
                    ...
                    for(long x1=static_cast<long>(0L); x1<static_cast<long>(192L); x1+=static_cast<long>(1L))
                    {
                        for(long x2=static_cast<long>(0L); x2<static_cast<long>(64L); x2+=static_cast<long>(16L))
                        {
                            ...
                            [&]
                            {
                                ...
                                for (long x2_inner = 0; x2_inner < 16; x2_inner++)
                                {
                                    tmpbuf[x2_inner] = in_ptr2[static_cast<long>((33L*x0) + (33L*(c10::div_floor_integer((x2 + x2_inner + (64L*x1)), 135168L))) + (c10::div_floor_integer((x2 + x2_inner + (64L*x1)), 4096L)))];
                                }
                                return at::vec::VectorizedN<int64_t,2>::loadu(tmpbuf.data(), 16);
                            }
                            ()
                            ...
                            [&]
                            {
                                ...
                                for (long x2_inner = 0; x2_inner < 16; x2_inner++)
                                {
                                    tmpbuf[x2_inner] = in_ptr2[static_cast<long>(30L + (33L*x0) + (33L*(c10::div_floor_integer((122880L + x2 + x2_inner + (64L*x1)), 135168L))) + (c10::div_floor_integer((x2 + x2_inner + (64L*x1)), 4096L)))];
                                }
                                return at::vec::VectorizedN<int64_t,2>::loadu(tmpbuf.data(), 16);
                            }
                            ()
                            ...
                            [&]
                            {
                                ...
                                for (long x2_inner = 0; x2_inner < 16; x2_inner++)
                                {
                                    tmpbuf[x2_inner] = in_ptr6[static_cast<long>(x2 + x2_inner + (64L*(static_cast<long>(c10::div_floor_integer(tmp11[x2_inner], 13L)) % static_cast<long>(12L))) + (768L*(static_cast<long>(x1) % static_cast<long>(64L))) + (49152L*(static_cast<long>(tmp11[x2_inner]) % static_cast<long>(13L))))];
                                }
                                return at::vec::Vectorized<bfloat16>::loadu(tmpbuf.data(), 16);
                            }
                            ()
                            ...
                            [&]
                            {
                                ...
                                for (long x2_inner = 0; x2_inner < 16; x2_inner++)
                                {
                                    tmpbuf[x2_inner] = in_ptr6[static_cast<long>(x2 + x2_inner + (64L*(static_cast<long>(c10::div_floor_integer(tmp21[x2_inner], 13L)) % static_cast<long>(12L))) + (768L*(static_cast<long>(x1) % static_cast<long>(64L))) + (49152L*(static_cast<long>(tmp21[x2_inner]) % static_cast<long>(13L))))];
                                }
                                return at::vec::Vectorized<bfloat16>::loadu(tmpbuf.data(), 16);
                            }
                            ()
                            ;
                            tmp14.store(out_ptr16 + static_cast<long>(x2 + (64L*x1) + (28672L*x0)), 16);
                            tmp24.store(out_ptr17 + static_cast<long>(x2 + (64L*x1) + (28672L*x0)), 16);
                        }
                    }
                }
            }
        ...
        int tid = omp_get_thread_num();
        {
            ...
            for(long x0=static_cast<long>(0L); x0<static_cast<long>(12L); x0+=static_cast<long>(1L))
            {
                ...
                for(long x1=static_cast<long>(0L); x1<static_cast<long>(9L); x1+=static_cast<long>(1L))
                {
                    ...
                    {
                        for(long x3=static_cast<long>(0L); x3<static_cast<long>(64L); x3+=static_cast<long>(16L))
                        {
                            auto tmp0 =
                            [&]
                            {
                                ...
                                {
                                    tmpbuf[x3_inner] = in_ptr0[static_cast<long>(3L + (3L*x1) + (33L*x0) + (33L*(c10::div_floor_integer((12288L + x3 + x3_inner + (64L*x2) + (12288L*x1)), 135168L))) + (c10::div_floor_integer((x3 + x3_inner + (64L*x2)), 4096L)))];
                                }
                                return at::vec::VectorizedN<int64_t,2>::loadu(tmpbuf.data(), 16);
                            }
                            ()
                            ...
                            [&]
                            {
                                ...
                                for (long x3_inner = 0; x3_inner < 16; x3_inner++)
                                {
                                    tmpbuf[x3_inner] = static_cast<long>((13L*x0) + (13L*(c10::div_floor_integer((3L + (3L*x1) + (c10::div_floor_integer((x3 + x3_inner + (64L*x2)), 4096L))), 33L))) + (13L*(c10::div_floor_integer((12288L + x3 + x3_inner + (64L*x2) + (12288L*x1)), 135168L))));
                                }
                                return at::vec::VectorizedN<int64_t,2>::loadu(tmpbuf.data(), 16);
                            }
                            ()
                            ...
                            [&]
                            {
                                ...
                                for (long x3_inner = 0; x3_inner < 16; x3_inner++)
                                {
                                    tmpbuf[x3_inner] = static_cast<long>(tmp11[x3_inner]);
                                }
                                return at::vec::Vectorized<int32_t>::loadu(tmpbuf.data(), 16);
                            }
                            ()
                            ...
                            [&]
                            {
                                ...
                                for (long x3_inner = 0; x3_inner < 16; x3_inner++)
                                {
                                    tmpbuf[x3_inner] = in_ptr1[static_cast<long>(x3 + x3_inner + (64L*(static_cast<long>(c10::div_floor_integer(tmp11[x3_inner], 13L)) % static_cast<long>(12L))) + (768L*(static_cast<long>(x2) % static_cast<long>(64L))) + (49152L*(static_cast<long>(tmp11[x3_inner]) % static_cast<long>(13L))))];
                                }
                                return at::vec::Vectorized<bfloat16>::loadu(tmpbuf.data(), 16);
                            }
                            ()
                            ...
                            [&]
                            {
                                ...
                                for (long x3_inner = 0; x3_inner < 16; x3_inner++)
                                {
                                    tmpbuf[x3_inner] = in_ptr2[static_cast<long>(x3 + x3_inner + (64L*(static_cast<long>(c10::div_floor_integer(tmp11[x3_inner], 13L)) % static_cast<long>(12L))) + (768L*(static_cast<long>(x2) % static_cast<long>(64L))) + (49152L*(static_cast<long>(tmp11[x3_inner]) % static_cast<long>(13L))))];
                                }
                                return at::vec::Vectorized<bfloat16>::loadu(tmpbuf.data(), 16);
                            }
                            ()
                            ;
                            tmp14.store(out_ptr0 + static_cast<long>(x3 + (64L*x2) + (12288L*x1) + (110592L*x0)), 16);
                            tmp15.store(out_ptr1 + static_cast<long>(x3 + (64L*x2) + (12288L*x1) + (110592L*x0)), 16);
                        }
                    }
                }
            }
                ...
                for(long x1=static_cast<long>(0L); x1<static_cast<long>(9L); x1+=static_cast<long>(1L))
                {
                    ...
                    for(long x2=static_cast<long>(0L); x2<static_cast<long>(64L); x2+=static_cast<long>(1L))
                    {
                        for(long x3=static_cast<long>(0L); x3<static_cast<long>(192L); x3+=static_cast<long>(16L))
                        {
                            ...
                            ()
                            ;
                            TORCH_CHECK((at::vec::VecMask<int32_t,1>((at::vec::Vectorized<int32_t>(0) <= tmp13) & (tmp13 < at::vec::Vectorized<int32_t>(13L)))).all_masked(), "index out of bounds: 0 <= tmp13 < 13L");
                            auto tmp15 =
                            [&]
                            {
                                __at_align__ std::array<float, 16> tmpbuf;
