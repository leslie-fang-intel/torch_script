...
extern "C" void kernel(const uint16_t* a, const uint16_t* b, uint16_t* result, uint16_t* result2)
{
    ...
    __m256i lower_256 = _mm512_cvtepi32_epi16(vec_a);

    __m512i shifted = _mm512_srli_epi32(vec_a, 16);
    __m256i higher_256 = _mm512_cvtepi32_epi16(shifted);
    
    _mm256_storeu_si256((__m256i*)result, lower_256);
    _mm256_storeu_si256((__m256i*)result2, higher_256);
