...
def run_qat_model(model_name):
    ...
    for i, (images, _) in enumerate(cal_loader):
        ...
        # torch.ao.quantization.move_exported_model_to_eval(exported_model)
        # from torch.ao.quantization.pt2e.utils import _fuse_conv_bn_
        # _fuse_conv_bn_(exported_model)
...
def run_fine_tune_model(model_name):
    ...
    with torch.no_grad():
        ...
        # model.eval()
        torch.ao.quantization.move_exported_model_to_eval(prepared_model)
        optimized_model = prepared_model
