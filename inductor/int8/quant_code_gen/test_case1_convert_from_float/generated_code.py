...
{
    {
        ...
        // 2352 = 150528 / 64
        #pragma GCC ivdep
        for(long i0=static_cast<long>(0); i0<static_cast<long>(2352); i0+=static_cast<long>(1))
        {
            ...
            //if (i0 == 10) {
            auto tmp = in_ptr0 + (static_cast<long>(i0)) * 64;
            auto res2 = at::vec::Vectorized<uint8_t>::convert_from_float(tmp);
