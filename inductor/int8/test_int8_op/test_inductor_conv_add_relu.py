...
class SimpleNet(torch.nn.Module):
    ...
    def forward(self, x, x2):
        ...
        return self.relu(self.conv1(x) + x2)
...
def test_inductor_pytorch_op():
    with torch.no_grad():
        ...
        conv1 = qconv(
            ...
            None, strides, paddings, dilations, groups, torch.tensor(Y_scale), torch.tensor(Y_zero_point), "add_relu")
        ...
        res.cpu().numpy(),
        decimal=2)
        print("Finish the inductor conv add relu test", flush=True)
