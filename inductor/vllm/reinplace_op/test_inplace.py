...
def reshape_and_cache(key, value, key_cache, value_cache, slot_mapping) -> None:
    return 

def test(key, value, key_cache, value_cache, slot_mapping):
    reshape_and_cache(
...
def _test_reshape_and_cache_func(
    ...
    ctest(key, value, key_cache, value_cache, slot_mapping)
