...
def test_pytorch_module():
    ...
    with torch.no_grad():
        ...
        print("model_quantized.conv_input_scale_0 is: {}".format(model_quantized.conv_input_scale_0), flush=True)
        print("model_quantized.conv_input_zero_point_0 is: {}".format(model_quantized.conv_input_zero_point_0), flush=True)
