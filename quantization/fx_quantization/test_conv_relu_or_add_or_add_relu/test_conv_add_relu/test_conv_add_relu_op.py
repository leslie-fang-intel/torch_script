...
def test_pytorch_op():
    with torch.no_grad():
        ...
        #x1 = torch.add(x, x)
        res_ref = relu(torch.add(conv1(x), conv2(x)))
        ...
        add_2 = relu(qadd(conv2, conv1, Y_scale, Y_zero_point))
