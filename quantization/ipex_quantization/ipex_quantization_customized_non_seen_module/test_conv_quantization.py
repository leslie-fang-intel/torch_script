...
class subNet(torch.nn.Module):
    def __init__(self):
        ...
        self.conv = torch.nn.Conv2d(64, 64, (3, 3), stride=(2, 2), padding=(1, 1), bias=False)
    def forward(self, x):
        return self.conv(x)
...
class SimpleNet(torch.nn.Module):
    def __init__(self):
        ...
        self.conv4 = torch.nn.Conv2d(64, 64, (3, 3), stride=(2, 2), padding=(1, 1), bias=False)
        self.relu = torch.nn.ReLU()
        # self.subnet = subNet()
        self.subnet = ipex.nn.modules.subNet()
...
if __name__ == "__main__":
    ...
    if CALI:
        with torch.no_grad():
            ...
            model(x, x2)
            print("Finish running", flush=True)
